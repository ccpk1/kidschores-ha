...
async def test_options_flow_init(
    ...
    assert result["step_id"] == OPTIONS_FLOW_STEP_INIT
...
async def test_options_flow_add_kid_success(
    ...
    assert result["type"] == FlowResultType.FORM
    assert result["step_id"] == OPTIONS_FLOW_STEP_MANAGE_ENTITY
    ...
    assert result["type"] == FlowResultType.FORM
    assert result["step_id"] == OPTIONS_FLOW_STEP_ADD_KID
...
async def test_options_flow_add_kid_duplicate_name(
    ...
    assert "kid_name" in result["errors"]
