...
| ----------- | ---------------------------- | ---------- | ---------------------------------------------------------- |
| **Phase 1** | Shared Infrastructure        | 0%         | ~50 lines: schema + mapping helpers (simpler than chores)  |
| **Phase 2** | Create Reward Service        | 0%         | ~40 lines: handler reuses `build_rewards_data()`           |
| **Phase 3** | Update Reward Service        | 0%         | ~40 lines: merge + validate logic (reuses Phase 1)         |
| **Phase 4** | Documentation & Translations | 0%         | services.yaml entries (reuses existing error translations) |
...
6. **Decisions & completion check**:
   ...
   - [ ] Completion: All phases complete, tests passing
