...
| Phase 4 – Tests                               | Update/create tests for unified path                                | 0%         | Existing midnight tests must be refactored                                                    |
...
3. **Next steps (short term)**
   - Implement Phase 1: extend `_evaluate_cumulative_badge` with date/grace/demotion awareness
   - Implement Phase 2: reduce midnight to `recalculate_all_badges()` + delete `process_cumulative_maintenance`
...
5. **References**
   ...
   - [CUMULATIVE_BADGE_RETENTION_FIX_IN-PROCESS.md](CUMULATIVE_BADGE_RETENTION_FIX_IN-PROCESS.md) — Prior work that created the dual-path problem
   - [CUMULATIVE_BADGE_RETENTION_FIX_SUP_GAP_ANALYSIS.md](CUMULATIVE_BADGE_RETENTION_FIX_SUP_GAP_ANALYSIS.md) — Gap analysis including dead signals
...
- This work supersedes the dual-path design documented in `CUMULATIVE_BADGE_RETENTION_FIX_IN-PROCESS.md` Phase 2. That plan should be updated to reference this initiative.
