...
- **Key issues**
  - Ensure all DEFAULT\_\* constants already exist (they do per ARCHITECTURE.md)
...
- **Steps / detailed work items**
  ...
  3. - [x] Update all callers to pass config_entry
     ...
     - **init**.py line ~193 (startup backup): Pass `entry`
...
- [const.py](../../custom_components/kidschores/const.py) – CONF*\* and DEFAULT*\* constants
