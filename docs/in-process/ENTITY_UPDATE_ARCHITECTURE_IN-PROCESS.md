...
| Phase 4 – Tests & Validation     | Add entity-update assertion helpers, validate all      | 0%         | New test utility: assert_entity_refresh_after()             |
...
3. **Next steps (short term)** – Phase 1 implementation (coordinator method), then systematic Phase 2 migration
...
5. **References**
   ...
   - [ENTITY_UPDATE_ARCHITECTURE_SUP_AUDIT_DATA.md](ENTITY_UPDATE_ARCHITECTURE_SUP_AUDIT_DATA.md) – Full audit data (orphan classifications, signal routing map)
